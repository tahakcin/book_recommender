...
def retrieve_semantic_recommendations(
    ...
    books_list = [int(recs.page_content.strip('"').split()[0]) for recs in recs]
    filtered = books[books["isbn13"].isin(books_list)]
    book_recs = filtered.head(final_top_k)
...
with gr.Blocks(theme = gr.themes.Glass()) as dashboard:
    ...
    with gr.Row():
        ...
        tone_dropdown = gr.Dropdown(choices=categories, label="Select an emotional tone:", value="All")
